          ...
          <div className="flex justify-between items-center">
            <div className="flex space-x-7 items-center">
              ...
              <div className="hidden md:flex items-center space-x-1">
                <Link
                  to="/"
                  className={`py-6 px-4 text-lg font-semibold ${
                    isActive("/")
            ...
            <div className="hidden md:flex items-center space-x-3 relative">
              <Link
                to="/cart"
                className="py-2 px-5 font-medium text-white rounded hover:bg-orange-500 hover:text-white transition duration-300 relative"
              >
                  ...
                  <div className="absolute right-0 mt-2 w-48 bg-white border rounded-lg shadow-xl z-20">
                    {isLoggedIn ? (
                      <>
                        <Link
                          to="/profile"
                          className="block px-4 py-2 text-gray-800 hover:bg-orange-500 hover:text-white hover:border rounded-lg"
                        >
                          Your Profile
                        </Link>
                        <Link
                        ...
                        <button
                          className="block w-full text-left px-4 py-2 text-gray-800 hover:bg-orange-500 hover:text-white hover:border rounded-lg"
            ...
            <li>
              <Link
                ...
                className={`block text-sm px-2 py-4 ${
                  location.pathname === "/"
                    ? "text-black bg-orange-500 font-semibold"
                    : "text-black hover:bg-orange-500 hover:text-white transition duration-300"
                }`}
              >
                Home
              </Link>
            ...
            {isLoggedIn ? (
              <>
                <li>
                  <Link
                    to="/profile"
                    className="block text-sm px-2 py-4 text-black hover:bg-orange-500 hover:text-white"
                  >
                    Your Profile
                  </Link>
                </li>
                ...
                <li>
                  <button
                    className="block w-full text-left text-sm px-2 py-4 text-black hover:bg-orange-500 hover:text-white"
                    onClick={handleLogout}
                  >
                    Logout
                  </button>
